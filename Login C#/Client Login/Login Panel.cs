...
namespace Client_Login
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sqa = new SqlDataAdapter("Select count(*) From tblLogin where Username = '" + emlog.Text + "' and Password = '" + passlog.Text + " ' ", con);
            DataTable dt = new DataTable();
            sqa.Fill(dt);

            if (dt.Rows[0][0].ToString() == "1") //Al validar usuario, pasa al dashboard
            {
